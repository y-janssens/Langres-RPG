...
impl Summary {
    pub fn compute(&mut self, history: &Vec<BattleLog>) -> Self {
    ...
    fn compute_healing(&self, history: &Vec<BattleLog>, initiator: Operator) -> i32 {
        history
            .iter()
    ...
    fn compute_objects(&self, history: &Vec<BattleLog>, operator: Operator) -> i32 {
        history
            .iter()
    ...
    fn compute_turns(&self, history: &Vec<BattleLog>) -> i32 {
        history
            .iter()
